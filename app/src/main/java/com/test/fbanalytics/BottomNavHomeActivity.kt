...
import com.test.fbanalytics.databinding.ActivityBottomNavHomeBinding
...
class BottomNavHomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_activity_bottom_nav_home)
